...
int64 nChainStartTime = 1461934872;
...
const string strMessageMagic = "HuahuiMerchantFinancial Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HuahuiMerchantFinancial
    bool fStrictPayToScriptHash = true; // Always active in HuahuiMerchantFinancial
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HuahuiMerchantFinancial", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "HuahuiMerchant Huahui empty mapBlockIndex Huahui Merchant Financial";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 426211 : 426211;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xc45ee24d700cb31df180c03e8bd808cc75b061f0e2eff547309ec047a6948db1"));
...
unsigned char pchMessageStart[4] = { 0xe6, 0xcf, 0x5f, 0xdb };

TEMPLATE = app
TARGET = HuahuiMerchantFinancial-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = HuahuiMerchantFinancial-qt_test
...
macx:ICON = src/qt/res/icons/HuahuiMerchantFinancial.icns
macx:TARGET = "HuahuiMerchantFinancial-Qt"
